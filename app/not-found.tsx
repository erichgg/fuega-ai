  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-void px-4">
      ...
      <div className="mt-8 text-center">
        ...
        <p className="mt-2 text-lg text-ash">Page not found</p>
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-lg border border-charcoal px-6 py-2.5 text-sm font-medium text-ash transition-colors hover:border-charcoal hover:text-foreground"
          >
