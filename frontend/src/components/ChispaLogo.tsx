export function ChispaLogo({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Fuega AI logo">
      <defs>
        <linearGradient id="fuega-bg" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF6B2C" />
          <stop offset="0.45" stopColor="#FF3CAC" />
          <stop offset="1" stopColor="#8B5CF6" />
        </linearGradient>
        <linearGradient id="fuega-flame" x1="16" y1="5" x2="16" y2="27" gradientUnits="userSpaceOnUse">
        ...
        <radialGradient id="fuega-inner" cx="16" cy="18" r="8" gradientUnits="userSpaceOnUse">
      ...
      <rect width="32" height="32" rx="7.5" fill="url(#fuega-bg)" />

      {/* Subtle inner glow */}
      <rect width="32" height="32" rx="7.5" fill="url(#fuega-inner)" />
